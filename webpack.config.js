                ...
                HtmlWebpackPlugin.getHooks(compilation).beforeEmit.tapAsync(
                    ...
                    (data, cb) => {
                        ...
                        const nav = [
									...
									'        <div class="btn-group">',
									'          <a class="nav-link dropdown-link" href="teaching.html">Teaching</a>',
									'          <a class="nav-link dropdown-toggle dropdown-toggle-split" href="#" id="teach" role="button" data-bs-toggle="dropdown" aria-expanded="false"> </a>',
									...
									"      </li>",
									'      <li class="nav-item dropdown">',
									'        <a class="nav-link dropdown-toggle" href="#" id="code" role="button" data-bs-toggle="dropdown" aria-expanded="false">',
									"          Code-box",
									"        </a>",
									'        <ul class="dropdown-menu">',
