	...
	apply(compiler) {
		compiler.hooks.compilation.tap("nav_inject", (compilation) => {
			HtmlWebpackPlugin.getHooks(compilation).beforeEmit.tapAsync(
				'nav_inject',
				(data, cb) => {
					if (data.html.includes("this_one")) {
						data.html = data.html
					} else {
