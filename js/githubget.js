...
const token = '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';
const cacheKey = `githubRepos_${username}`;
const cacheDuration = 5 * 24 * 60 * 60 * 1000; // 3 days in milliseconds
